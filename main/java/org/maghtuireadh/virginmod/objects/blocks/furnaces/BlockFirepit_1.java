...
public class BlockFirepit_1 extends Block implements ITickable, IHasModel{

	

private boolean isBurning, isStoked;

private int firepitBurnTime, fuelLvl, burnRate, coalBurn, coalCount, coalGrowth, coalRate, ashBurn, ashCount, ashGrowth, ashRate;
...
World worldIn;
	...
	public BlockFirepit_1(String name, Material material) {
		super(material);
...
protected BlockFirepit_1(boolean isBurning){
